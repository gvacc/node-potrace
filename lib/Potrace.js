...
Potrace.prototype = {
   ...
   * @param {String} [outline] - overrides outline from parameters
   * @returns {String}
   */
  getPathTag: function(fillColor, outline) {
    fillColor = arguments.length < 1 ? this._params.color : fillColor;
    outline = arguments.length < 2 ? this._params.outline : outline;
    ...
    tag += '" stroke="' + outline + '" fill="' + fillColor + '" fill-rule="evenodd"/>';
  ...
  getSVG: function() {
    ...
    return '<svg xmlns="http://www.w3.org/2000/svg" ' +
      ...
      (this._params.background !== Potrace.COLOR_TRANSPARENT
        ...
        : '') +
      '\t' + this.getPathTag(this._params.color, this._params.outline) + '\n' +
      '</svg>';
  }
};
 ...
 * @property {string}  [outline]      - border color (default: 'none')
 */
